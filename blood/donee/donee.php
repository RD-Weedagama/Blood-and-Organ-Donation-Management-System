                    ...
                    <div class="row">
                      <div class="col">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">Blood Donee</h4>
                              <p class="card-text">Who can get blood from blood donors is referred to as a blood donee.</p>
                              <a href="signup-user.php" class="btn btn-primary w-25" data-bs-toggle="tooltip" data-bs-placement="bottom" title="රුධිර ග්‍රාහකයා"> Ok</a>
                      ...
                      <div class="col">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">Organ Donee</h4>
                              <p class="card-text">Organ donees are those who are eligible to receive organs from organ donors.</p>
                              
                              
                              <a href="signup-user.php" class="btn btn-primary w-25" data-bs-toggle="tooltip" data-bs-placement="bottom" title="අවයව ග්‍රාහකයා"> Ok</a>
