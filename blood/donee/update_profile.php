...
<?php 
	...
	$query = "SELECT name,email,gender,nic,dob,address,contact_no,blood_group,weight FROM usertable WHERE email = '$email'";
    ...
    <div class="card h-100">
        <div class="card-body">
            <div class="row gutters">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        <label for="website">Weight</label>
                        <input type="text" class="form-control" name="h" value="<?php echo $h ?>">
                    </div>
                </div>
            </div>
