...
if(isset($_POST['signup'])){
    ...
    if(count($errors) === 0){
        ...
        $insert_data = "INSERT INTO usertable (name, email, password, code, status, A, B ,C , D, E,F,G,A2, B2 ,C2 ,
         D2, E2,F2,H,I, A4, B4 ,C4 , D4, E4,F4, A5, B5 ,C5 , D5, A6, B6 ,C6,gender,nic,dob,address,contact_no,blood_group,weight)
                        values('$name', '$email', '$encpass', '$code', '$status','$A','$B','$C','$D','$E','$F','$G',
                        '$A2','$B2','$C2','$D2','$E2','$F2','$H','$I','$A4','$B4','$C4','$D4','$E4','$F4','$A5','$B5'
                        ,'$C5','$D5','$A6','$B6','$C6','$gender','$nic','$dob','$address','$contact_no','$blood_group','$weight')";
