        ...
        <table class="table table-hover">
            ...
            <tr>
              ...
              <td><div class="form-check">
                  <input class="form-check-input" type="radio" name="A"  value="<?php echo $A ?>" >
            ...
            <tr>
              ...
              <td><div class="form-check">
                  <input class="form-check-input" type="radio" name="D"  value="yes" value="<?php echo $D ?>">
                  <label class="form-check-label">
                    Yes
                  </label>
                </div></td>
              <td><div class="form-check">
                  <input class="form-check-input" type="radio" name="D"  value="no" value="<?php echo $D ?>">
                  <label class="form-check-label">
                    No
                  </label>
                </div></td>
            ...
            <tr>
              ...
              <td><div class="form-check">
                  <input class="form-check-input" type="radio" name="E"  value="yes" value="<?php echo $E ?>">
                  <label class="form-check-label">
                    Yes
                  </label>
                </div></td>
              <td><div class="form-check">
                  <input class="form-check-input" type="radio" name="E"  value="no" value="<?php echo $E ?>">
                  <label class="form-check-label">
                    No
                  </label>
                </div></td>
            ...
            <tr>
              ...
              <td><div class="form-check">
                  <input class="form-check-input" type="radio" name="F"  value="yes" value="<?php echo $F ?>">
                  <label class="form-check-label">
                    Yes
                  </label>
                </div></td>
              <td><div class="form-check">
                  <input class="form-check-input" type="radio" name="F"  value="no" value="<?php echo $F ?>">
                  <label class="form-check-label">
                    No
                  </label>
                </div></td>
            ...
            <tr>
              ...
              <td><div class="form-check">
                  <input class="form-check-input" type="radio" name="G"  value="yes" value="<?php echo $G ?>">
                  <label class="form-check-label">
                    Yes
                  </label>
                </div></td>
              <td><div class="form-check">
                  <input class="form-check-input" type="radio" name="G"  value="no" value="<?php echo $G ?>">
                  <label class="form-check-label">
                    No
                  </label>
                </div></td>
