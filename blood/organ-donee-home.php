...
if($email != false && $password != false){
    $sql = "SELECT * FROM organ_donee WHERE email = '$email'";
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="organ-search.php">Seacrh for organ</a>
              </li>
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item" href="organ-donee-profile.php">Profile</a></li>
