                ...
                <div class="card mt-4">
                  ...
                  <?php
                    ...
                    if(isset($_POST['ser']))
                    {
                        ...
                        $search = $_POST['search'];
                        $sql = "SELECT * FROM student_table WHERE blood='$search'";
                                    ...
                                    echo "<tr>";
                                        ...
                                        ?>
                                                    <tr>
                                                        ...
                                                        <input type="hidden" name="blo" value="<?php echo $row['blood'];?>">     
    
                                                        <button type="submit" name="request" class="btn btn-primary">Request</button></form></td>                                                      
