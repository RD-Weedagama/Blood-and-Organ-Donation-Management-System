		...
		<div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="text-right">
                    <a class="btn btn-secondary" href="organ-donee-home.php" role="button">Cancel</a>
                    <a class="btn btn-primary" href="organ-donee-update-profile.php" role="button">Update</a>
				</div>
			</div>
		</div>
	</div>
