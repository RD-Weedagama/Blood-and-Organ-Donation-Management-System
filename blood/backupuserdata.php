...
if(isset($_POST['signup'])){
    ...
    if(count($errors) === 0){
        ...
        $insert_data = "INSERT INTO usertable (name, email, password, code, status, A, B ,C , D, E,F,G,A2, B2 ,C2 ,
         D2, E2,F2,H,I, A4, B4 ,C4 , D4, E4,F4, A5, B5 ,C5 , D5, A6, B6 ,C6,gender,nic,dob,address,contact_no,blood_group,weight,verify)
                        values('$name', '$email', '$encpass', '$code', '$status','$A','$B','$C','$D','$E','$F','$G',
                        '$A2','$B2','$C2','$D2','$E2','$F2','$H','$I','$A4','$B4','$C4','$D4','$E4','$F4','$A5','$B5'
                        ,'$C5','$D5','$A6','$B6','$C6','$gender','$nic','$dob','$address','$contact_no','$blood_group','$weight',' $verify')";
   ...
   //reg3 page
  ...
  
    {
        ...
        if(mysqli_connect_error()){
            ...
            $update_don = "UPDATE usertable SET H = '$H', I = '$I' WHERE email = '$email'";
            $update_res = mysqli_query($con, $update_don);
            if($update_res){
     ...
     if(isset($_POST['submit2'])){
       ...
       // echo $ck;
        ...
        if(mysqli_connect_error()){
            ...
            $update_don = "UPDATE usertable SET A2 = '$A2', B2 = '$ck', C2 = '$C2', D2 = '$D2', E2 = '$E2', F2 = '$F2'  WHERE email = '$email'";
            $update_res = mysqli_query($con, $update_don);
            if($update_res){
   ...
   if(isset($_POST['submit4'])){
    ...
    if(mysqli_connect_error()){
        ...
        $update_don = "UPDATE usertable SET A4 = '$A4', B4 = '$B4', C4 = '$C4', D4 = '$D4', E4 = '$E4', F4 = '$F4' WHERE email = '$email'";
$update_res = mysqli_query($con, $update_don);
    if($update_res){
 ...
 if(isset($_POST['submit5'])){
    ...
    if(mysqli_connect_error()){
        ...
        $update_don = "UPDATE usertable SET A5 = '$A5', B5 = '$B5', C5 = '$C5', D5 = '$D5' WHERE email = '$email'";
$update_res = mysqli_query($con, $update_don);
    if($update_res){
...
if(isset($_POST['submit6'])){
    ...
    if(mysqli_connect_error()){
        ...
        $update_don = "UPDATE usertable SET A6 = '$A6', B6 = '$B6', C6 = '$C6' WHERE email = '$email'";
        $update_res = mysqli_query($con, $update_don);
        if($update_res){
...
if(isset($_POST['agreement'])){
    ...
    if(mysqli_connect_error()){
        ...
        $update_don = "UPDATE usertable SET timeA = '$timeA'WHERE email = '$email'";
        $update_res = mysqli_query($con, $update_don);
        if($update_res){
...
if(isset($_POST['personal'])){
    ...
    if(mysqli_connect_error()){
        ...
        $update_don = "UPDATE usertable SET gender = '$gender', nic = '$nic', dob = '$dob', address = '$address', contact_no = '$contact_no', blood_group = '$blood_group', weight = '$weight' WHERE email = '$email'";
        $update_res = mysqli_query($con, $update_don);
        if($update_res){
...
if(isset($_POST['save'])){
   ...
   if(isset($_POST['don'])){
    ...
    if(mysqli_connect_error()){
        ...
        $update_don = "UPDATE usertable SET donA = '$donA', donB = '$donB', donC = '$donC', donD = '$donD', donE = '$donE' WHERE email = '$email'";
$update_res = mysqli_query($con, $update_don);
    if($update_res){
   ...
   echo "$req_id";
    ...
    if(mysqli_connect_error()){
        ...
        $update_don = "UPDATE blood_request SET status = '1' WHERE id = '$req_id'";
$update_res = mysqli_query($con, $update_don);
    if($update_res){
        echo "hello";
