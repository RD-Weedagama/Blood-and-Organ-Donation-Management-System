...
<?php 
	...
	$query = "SELECT name,email,gender,nic,dob,address,contact_no FROM organ_donee WHERE email = '$email'";
...
<form action="controllerOrganDoneeData.php" method="POST" autocomplete="off">
        ...
        <div class="card-body">
            ...
            <div class="row gutters">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <a class="btn btn-secondary" href="organ-donor-profile.php" role="button">Cancel</a>
