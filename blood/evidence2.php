       ...
       <form action="controllerOrganDonorData.php" method="POST" autocomplete="off" enctype="multipart/form-data">
        ...
        <table class="table table-hover">
              ...
              <tr>
                ...
                <td class="col-form-label" data-bs-toggle="tooltip" data-bs-placement="bottom" title="">Deponent 2</td>
              ...
              <tr>
                ...
                <td colspan="2" class="align-items-lg-start">
                    <div class="form-group">
                        <input type="text" class="form-control"  name="nic2" required> 
                    </div>
                    <td></td>
              ...
              <tr>
                ...
                <td colspan="2" class="align-items-lg-start">
                    <div class="form-group">
                        <input type="text" class="form-control"  name="relationship2" required> 
                    </div>
                    <td></td>
              ...
              <tr>
                ...
                <td colspan="2" class="col-form-label">
                    <div class="form-group">
                        <input type="text" class="form-control"  maxlength="10" name="contact_no2" required>
                    </div>
              ...
              <tr>
                ...
                <td colspan="2" class="col-form-label">
                    <div class="form-group">
                        <input type="text" class="form-control"  maxlength="10" name="email2" required>
                    </div>
          ...
          <div class="text-end">
          <input type="submit" class="btn btn-dark" value="Next" name="evi2">
</div>
       </form>
