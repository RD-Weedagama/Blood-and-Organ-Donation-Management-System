...
<script>
  ...
  <script type="text/javascript">
    ...
    <div class="login-box">
       <form action="controllerUserData.php" method="POST" autocomplete="off" enctype="multipart/form-data">
        ...
        <td colspan="4"><h3> <b> Personal Details</b></h3></td>
              ...
              <tr>
                ...
                <td colspan="3" class="align-items-lg-start">
              ...
              <tr>
                ...
                <td colspan="4" class="align-items-lg-start">
              ...
              <tr>
                ...
                <td><div class="form-check">
                  <input class="form-check-input" type="radio" name="gender" onclick="EnableDisableTextBox()"  value="male" >
                  <label class="form-check-label">
                    Male
                  </label>
                </div></td>
              <td><div class="form-check">
                  <input class="form-check-input" type="radio" name="gender" onclick="EnableDisableTextBox()"  value="female" >
                  <label class="form-check-label">
                    Female
                  </label>
                </div></td>
                <td><div class="form-check">
                  <input class="form-check-input" type="radio" name="gender" id="chkYes"  onclick="EnableDisableTextBox()">
                  <label class="form-check-label">
                    Other
                  </label>
                </div></td>
                    <td class="align-items-lg-start">
                    <div class="form-group">
                        
                        <input type="text" class="form-control" placeholder="Other" id="txtPassportNumber" name="gender"  >
                    </div> 
                    </td>
              </tr>
              ...
              <tr>
                ...
                <td colspan="4" class="col-form-label">
                    <div class="form-group">
              ...
              <tr>
                <th >H)</th>
                <td class="col-form-label" data-bs-toggle="tooltip" data-bs-placement="bottom" title="බර">Weight</td>
                <td colspan="4" class="align-items-lg-start">
                    <div class="form-group">
