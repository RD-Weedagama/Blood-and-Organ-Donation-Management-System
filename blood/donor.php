                    ...
                    <div class="row">
                      <div class="col">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">Signup as a blood donor</h4>
                      ...
                      <div class="col">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">Signup as a organ donor</h4>
                              <p class="card-text">The one who's donating organs for the people who need organs are known as organ donors.</p>
                              <a href="signup-organ-donor.php" class="btn btn-primary w-25" data-bs-toggle="tooltip" data-bs-placement="bottom" title="අවයව දායකයා"> Ok</a>
