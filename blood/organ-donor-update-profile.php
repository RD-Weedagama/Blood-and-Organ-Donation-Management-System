...
<?php 
	...
	$query = "SELECT name,email,gender,nic,dob,address,contact_no FROM organ_donor WHERE email = '$email'";
...
<form action="controllerOrganDonorData.php" method="POST" autocomplete="off">
        ...
        <div class="card-body">
            <div class="row gutters">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="b" value="<?php echo $b ?>">
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="f" value="<?php echo $f ?>">
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        <label for="phone">Contact No</label>
                        <input type="text" class="form-control" name="g" value="<?php echo $g ?>">
                    </div>
                </div>
            ...
            <div class="row gutters">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <a class="btn btn-secondary" href="organ-donee-profile.php" role="button">Cancel</a>
