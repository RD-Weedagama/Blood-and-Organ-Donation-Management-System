<?php require_once "controllerBloodDoneeData.php"; ?>
<?php 
      ...
      <div class="container mt-2 mb-2 px-3 pt-5">
        <div class="row g-0">
          ...
          <div class="col-lg-7  px-5 pt-5">
            ...
            <form action="blood-donee-new-password.php" method="POST" autocomplete="off">
              
              <div class="form-row">
                <div class="">
                  <input class="form-control p-3 my-3 " type="password" name="password" placeholder="Create new password" required>
                </div>
              </div>
              <div class="form-row">
                <div class="">
                  <input class="form-control p-3 my-3" type="password" name="cpassword" placeholder="Confirm your password" required>
                </div>
              </div>
              <div class="form-row">
              <div class="form-group">
                  <input class="form-control button btn1 my-3" type="submit" name="change-password" value="Change">
              </div>
              </div>
