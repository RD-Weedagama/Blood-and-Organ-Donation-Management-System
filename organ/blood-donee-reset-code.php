      ...
      <div class="container mt-2 mb-2 px-3 pt-5">
        <div class="row g-0">
          ...
          <div class="col-lg-7  px-5 pt-5">
            ...
            <form action="blood-donee-reset-code.php" method="POST" autocomplete="off">
            <h1>Code Verification</h1>
            <?php 
                    if(isset($_SESSION['info'])){
                        ?>
                        <div class="alert alert-success text-center" style="padding: 1.5rem 1.5rem">
              ...
              <div class="form-row">
                <div class="">
                  <input type="number" name="otp"  class="form-control p-3 my-3" placeholder="Enter code" required>
                </div>
              </div>
              <div class="form-row">
              <div class="form-group">
                  <input class="form-control button btn1 my-3" type="submit" name="check-reset-otp" value="Submit">
              </div>
              </div>
